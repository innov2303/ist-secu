      ...
      <div className="container relative z-10 px-4 mx-auto pt-12 pb-16 md:pb-24">
        ...
        >
          <div className="space-y-2">
            <Card className="border-transparent py-2 max-w-md" data-testid="card-audit-conformite">
            ...
            <div className="rounded-lg overflow-hidden border border-border/40 hover-elevate transition-all max-w-md">
              <img src={featureAudit} alt="Audit Sécurité" className="w-full h-auto object-cover" />
            </div>
          </div>

          <div className="space-y-2">
            <Card className="border-transparent py-2 max-w-md" data-testid="card-rapport">
              <CardHeader className="pb-1 pt-2">
                <CardTitle className="flex items-center gap-2 text-base">
          ...
          <div className="space-y-2">
            <Card className="border-transparent py-2 max-w-md" data-testid="card-secure">
              <CardHeader className="pb-1 pt-2">
                <CardTitle className="flex items-center gap-2 text-base">
          ...
          <div className="space-y-2">
            <Card className="border-transparent py-2 max-w-md" data-testid="card-evolution">
              <CardHeader className="pb-1 pt-2">
                <CardTitle className="flex items-center gap-2 text-base">
