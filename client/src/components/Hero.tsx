...
import featureSecure from "@assets/images/feature-secure-v2.png";
      ...
      <div className="container relative z-10 px-4 mx-auto pt-12 pb-16 md:pb-24">
        ...
        >
          <div className="space-y-2 flex flex-col items-center">
            ...
            <div className="rounded-lg overflow-hidden border border-border/40 hover-elevate transition-all max-w-xl w-full">
