        ...
        >
          <div className="space-y-3">
            ...
            <div className="rounded-lg overflow-hidden border border-border/40 hover-elevate transition-all">
              <img src={featureAudit} alt="Audit Sécurité" className="w-full h-24 object-cover" />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg overflow-hidden border border-border/40 hover-elevate transition-all">
              <img src={featureRapport} alt="Rapport & Recommendations" className="w-full h-24 object-cover" />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg overflow-hidden border border-border/40 hover-elevate transition-all">
              <img src={featureSecure} alt="Secure" className="w-full h-24 object-cover" />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="rounded-lg overflow-hidden border border-border/40 hover-elevate transition-all">
              <img src={featureEvolution} alt="Suivez l'évolution" className="w-full h-24 object-cover" />
            </div>
          </div>
        </motion.div>
      </div>
