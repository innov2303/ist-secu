...
Compatible Debian/Ubuntu, Red Hat/CentOS, Fedora, SUSE. Fonctionnement limité sur les distributions non listées.', 'linux-compliance-toolkit.zip', 'Terminal', 'ANSSI-BP-028 + CIS Benchmark', '{"Base + Enhanced","~215 contrôles total","ANSSI + CIS","Rapports HTML/JSON"}', 0, 8000, '{6,9}', false, 'active', '1.0.0'),
...
Compatible ESXi 7.0 et 8.0. Exécution depuis Windows avec PowerShell 5.1+ et VMware PowerCLI.', 'vmware-esxi-compliance-toolkit.zip', 'Server', 'CIS', '{"Base + Enhanced","~165 contrôles total","CIS Benchmark","PowerCLI","Rapports HTML/JSON"}', 0, 10000, '{13,14}', false, 'development', '1.0.0'),
...
Compatible Docker 20.10+, Podman 4.0+ (via API Docker-compatible), Kubernetes 1.25+.', 'container-orchestration-toolkit.zip', 'Container', 'CIS Docker & Kubernetes', '{"Base + Enhanced","~160 contrôles total","CIS Docker + Kubernetes","Rapports HTML/JSON"}', 0, 10000, '{16,17}', false, 'development', '1.0.0'),
...
Execution PowerShell depuis Windows. Compatible avec tout site web accessible.', 'web-security-base.ps1', 'Globe', 'OWASP + ANSSI', '{"~55 controles de securite","Headers HTTP (CSP, HSTS, X-Frame)","Configuration TLS/SSL","Detection fichiers sensibles","Securite des cookies","Rapports HTML/JSON"}', 0, 20000, NULL, true, 'active', '1.0.0'),
...
results["ANSSI-SSH-001"]=$(check_anssi_ssh_001)', true),
...
results["ANSSI-SSH-002"]=$(check_anssi_ssh_002)', true),
...
$results["OWASP-HDR-001"] = Test-OWASPHDR001', true),
...
$results["OWASP-TLS-001"] = Test-OWASPTLS001', true),
...
$results["OWASP-TLS-002"] = Test-OWASPTLS002', true),
...
$results["OWASP-FILE-001"] = Test-OWASPFILE001', true),
