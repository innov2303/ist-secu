/**
 * IST HTML Report Templates for Scripts
 * Enterprise Gray Theme matching the IST website design
 */

// Common CSS for all reports (IST Enterprise Gray Theme)
export const IST_REPORT_CSS = `
...
.info-value { font-weight: 500; font-size: 13px; color: #1e293b; }
...
.result-content .id { font-family: monospace; font-size: 11px; color: #94a3b8; margin-top: 6px; }
...
.remediation-label { 
  font-weight: 600; color: #4b5563; margin-bottom: 4px;
  font-size: 11px; text-transform: uppercase; letter-spacing: 0.5px;
}
.remediation code { 
  font-family: monospace; background: #1e293b; 
  color: #22d3ee; padding: 2px 6px; border-radius: 4px; font-size: 12px;
}
.footer { 
...
// PowerShell Generate-HtmlReport function with IST design
export const POWERSHELL_HTML_FUNCTION = `
function Generate-HtmlReport {
    ...
    $targetInfo = if ($Report.metadata.target) { $Report.metadata.target } 
                  ...
                  elseif ($Report.metadata.cluster_name) { $Report.metadata.cluster_name }
...
.logo { background: white; color: #4b5563; padding: 8px 16px; border-radius: 8px; font-weight: 700; font-size: 14px; }
.summary-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 24px; }
...
.result-item.warn { border-left: 3px solid #eab308; }
.result-item.fail { border-left: 3px solid #ef4444; }
.result-status { width: 28px; height: 28px; border-radius: 6px; display: flex; align-items: center; justify-content: center; font-weight: 600; color: white; font-size: 12px; }
.result-status.pass { background: #22c55e; }
.result-status.warn { background: #eab308; }
.result-status.fail { background: #ef4444; }
.result-content h4 { font-size: 14px; font-weight: 500; margin-bottom: 4px; color: #1e293b; }
...
.result-content .id { font-family: monospace; font-size: 11px; color: #94a3b8; margin-top: 6px; }
.result-badges { display: flex; flex-direction: column; gap: 6px; align-items: flex-end; }
.badge { padding: 3px 10px; border-radius: 4px; font-size: 11px; font-weight: 500; text-transform: uppercase; letter-spacing: 0.3px; }
.badge.critical { background: #fce7f3; color: #be185d; }
.badge.high { background: #fee2e2; color: #b91c1c; }
.badge.medium { background: #fef3c7; color: #b45309; }
.badge.low { background: #f1f5f9; color: #475569; }
...
@media (max-width: 768px) { .summary-grid { grid-template-columns: 1fr; } .info-grid { grid-template-columns: 1fr; } }
    </style>
</head>
<body>
    <div class="container">
...
// Bash generate_html_report function with IST design
export const BASH_HTML_FUNCTION = `
