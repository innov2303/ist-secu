/**
 * IST HTML Report Template
 * This template provides a consistent design for all audit reports
 * matching the IST website's enterprise gray theme.
 */
...
// PowerShell version of the CSS (escaped for embedding)
export const POWERSHELL_REPORT_TEMPLATE = `
    ...
    <div class="container">
        <div class="header">
            <div class="header-top">
                <div>
                    ...
                    <div class="framework">\$($Report.metadata.compliance)</div>
                </div>
                <div class="logo">
                    <div class="logo-icon">
        ...
        <div class="summary-grid">
            ...
            <div class="card">
                ...
                <div class="info-grid">
                    <div class="info-item"><span class="info-label">Cible</span><span class="info-value">\$($Report.metadata.target)</span></div>
